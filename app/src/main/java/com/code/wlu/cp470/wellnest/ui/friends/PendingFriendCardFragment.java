...
public class PendingFriendCardFragment extends Fragment {
    Context context;
    private String uid;
    private String name;
    private int score;

    public PendingFriendCardFragment(String uid, String name, int score) {
        this.uid = uid;
        this.name = name;
        this.score = score;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_pending_friend_card, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton acceptFriendButton = view.findViewById(R.id.accept_friend_button);

        UiClickEffects.setOnClickWithPulse(view, v -> {
        ...
        UiClickEffects.setOnClickWithPulse(removeFriendButton, v -> {
        ...
        UiClickEffects.setOnClickWithPulse(acceptFriendButton, v -> {
            FriendViewModel viewModel = new FriendViewModel(requireActivity().getApplication());
            boolean success = viewModel.acceptFriend(uid);
            if (success) {
